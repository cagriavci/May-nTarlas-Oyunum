...
public class mayinYerlestirme extends mayinTarlasiOyunu implements ActionListener{
 ...
 int hak;
     ...
     if(mayin[point.x][point.y]<0){
        ...
        oyunBitti();
         ...
         if(mayin[point.x][point.y]>3) {
          ...
          hak--;
       if(hak==0)
          JOptionPane.showMessageDialog(null,"ZAFER","SONUC==", JOptionPane.INFORMATION_MESSAGE);
  ...
  public void oyunBitti(){
      ...
      JOptionPane.showMessageDialog(null,"!!!MAĞLUBİYET!!!","Mayin",JOptionPane.INFORMATION_MESSAGE);
  }
    ...
    if(x<0 || y<0 || x>buttons.length-1 ||y>buttons.length-1)
     ...
     if(buttons[x][y].getText()=="  "){
       ...
       if(mayin[x][y]>0){
         ...
         hak--;
         if(hak==0)
           JOptionPane.showMessageDialog(null,"!!!ZAFERRRRR!!!", "Sonuc", JOptionPane.INFORMATION_MESSAGE);
       }
       ...
       if(mayin[x][y]==0){
           ...
           hak--;
         if(hak==0)
           JOptionPane.showMessageDialog(null,"ZAFERRRR!!!!!", "Sonuc", JOptionPane.INFORMATION_MESSAGE);
  ...
  public mayinYerlestirme(int boyut, int mayinSayisi){
     ...
     for(int j=0;j<mayinSayisi;j++){
       ...
       mayin[x][y]=-100;//tıklanan yerın  etrafının kontrolu
